  ...
  return (
    <div className="about__content">
      ...
      <article className="about__content-2">
        ...
        <p>Years later, we found our way back to each other, not just to relive the past, but because the weight of time
          had changed us. Along the road, we lost friends - some who once stood beside us in those first versions of the
          band - to struggles with mental health and to the cruelty of cancer. Their absence left a silence we couldn’t
          ignore, a silence that pushed us to write again, this time with a different purpose.</p>
